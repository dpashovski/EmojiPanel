...
var Create = function Create(options, emit, toggle) {
    ...
    if (options.editable && options.editable_content) {
        Emojis.load(options).then(function (res) {
