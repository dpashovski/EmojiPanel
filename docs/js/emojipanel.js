...
var Emojis = {
    ...
    updateContentEditable: function updateContentEditable(options) {
        ...
        options.editable_content.innerHTML = options.editable_content.innerHTML.replace(new RegExp(ranges.join('|'), 'g'), '<span class="RichEditor-pictographImage" data-emoji="$&" contenteditable="false">$&</span>');
